...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/admin/alternatif">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('C1') is-invalid @enderror" id="C1"
                    name="C1" required autofocus value="{{ old('C1') }}">
                @error('C1')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('C2') is-invalid @enderror" id="C2"
                    name="C2" required autofocus value="{{ old('C2') }}">
                @error('C2')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('C3') is-invalid @enderror" id="C3"
                    name="C3" required autofocus value="{{ old('C3') }}">
                @error('C3')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('C4') is-invalid @enderror" id="C4"
                    name="C4" required autofocus value="{{ old('C4') }}">
                @error('C4')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <button type="submit" class="btn btn-primary">Buat Alternatif</button>
        </form>
    </div>
@endsection
