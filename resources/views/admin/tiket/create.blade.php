        ...
        <form method="post" action="/admin/tiket">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('tanggal_event') is-invalid @enderror" id="tanggal_event"
                    name="tanggal_event" required placeholder="(tahun-bulan-hari)" autofocus value="{{ old('tanggal_event') }}">
                @error('tanggal_event')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('lokasi_event') is-invalid @enderror" id="lokasi_event"
                    name="lokasi_event" required autofocus value="{{ old('lokasi_event') }}">
                @error('lokasi_event')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('harga_tiket') is-invalid @enderror" id="harga_tiket"
                    name="harga_tiket" required autofocus value="{{ old('harga_tiket') }}">
                @error('harga_tiket')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('jumlah_pengunjung_hal') is-invalid @enderror" id="jumlah_pengunjung_hal"
                    name="jumlah_pengunjung_hal" required autofocus value="{{ old('jumlah_pengunjung_hal') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('tiket_terjual') is-invalid @enderror" id="tiket_terjual"
                    name="tiket_terjual" required autofocus value="{{ old('tiket_terjual') }}">
                @error('tiket_terjual')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
